...
public class Constants {
    ...
    public final static String field_bookginDatesCheck="bookingdates.check";
    public final static String value_empty="Empty";
    public final static String value_space="space";
}
